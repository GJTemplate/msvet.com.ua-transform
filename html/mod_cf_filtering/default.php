...
$document->addScript(JURI::root().'modules/mod_cf_filtering/assets/general-uncompressed.js?v=1');
$document->addScript(JURI::root().'media/system/js/modal.js?v=1');
$document->addStyleSheet(JURI::root().'templates/transform/html/mod_cf_filtering/style.min.css?v=1');
...
/*echo '<pre>'; print_r ( $filters_render_array['expanded_state'] ); echo '</pre>'.__FILE__.' in line:  '.__LINE__ ;
echo '<pre>'; print_r ( $filters_render_array ); echo '</pre>'.__FILE__.' in line:  '.__LINE__ ;
die(__FILE__.' in line '.__LINE__);*/

if( !isset($filters_render_array['expanded_state'])  ){
		
} // end if

 $expanded_state=!isset($filters_render_array['expanded_state'])? FALSE :$filters_render_array['expanded_state'];
