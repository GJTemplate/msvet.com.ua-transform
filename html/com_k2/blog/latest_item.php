...
<div class="latestItemView"> 
  ...
  <div class="latestItemBody yjk2_body"> 
    ...
    <!-- Item Image -->
    <div class="latestItemImageBlock"> <span class="latestItemImage"> <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
    ...
    <?php endif; ?>
    <div class="latestItemHeader yjk2_header">
      <?php if($this->item->params->get('latestItemTitle')): ?>
      <!-- Item title -->
      <h2 class="latestItemTitle yjk2_title">
      ...
      <!-- Date created --> 
      <span class="latestItemDateCreated yjk2_date"> <?php echo JHTML::_('date', $this->item->created , JText::_('YJ_DATE_FORMAT')); ?> </span>
      <?php endif; ?>
      <?php if($this->item->params->get('latestItemCategory')): ?>
      <!-- Item category name -->
      <div class="latestItemCategory yjk2_cat"> <span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span> <a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a> </div>
      <?php endif; ?>
    </div>
    <?php if($this->item->params->get('latestItemIntroText')): ?>
    <!-- Item introtext -->
    <div class="latestItemIntroText yjk2_intro"> <?php echo $this->item->introtext; ?> </div>
    <?php endif; ?>
    <div class="clr"></div>
  ...
  <div class="latestItemLinks">
    ...
    <!-- Item tags -->
    <div class="latestItemTagsBlock yjk2_tags"> <span><?php echo JText::_('K2_TAGGED_UNDER'); ?></span>
  ...
  <!-- Item "read more..." link -->
  <div class="latestItemReadMore"> <a class="k2ReadMore button_color" href="<?php echo $this->item->link; ?>"> <?php echo JText::_('YJ_READMORE'); ?> </a> </div>
  <?php endif; ?>
  <div class="clr"></div>
