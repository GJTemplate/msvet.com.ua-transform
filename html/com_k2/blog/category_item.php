...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
  ...
  <div class="catItemBody yjk2_body"> 
    ...
    <!-- Item Image -->
    <div class="catItemImageBlock effect-apollo"> 
     	<span class="catItemImage"> 
     	<a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" rel="nofollow">
    ...
    <div class="catItemHeader yjk2_header">
      ...
      <!-- Date created -->      
			<span class="catItemDateCreated yjk2_date">
  ...
  <!-- Item "read more..." link -->
  <div class="catItemReadMore"><a class="k2ReadMore button_color" href="<?php echo $this->item->link; ?>" rel="nofollow"> <?php echo JText::_('K2_READ_MORE'); ?> </a> </div>
  <?php endif; ?>
  <div class="clr"></div>
