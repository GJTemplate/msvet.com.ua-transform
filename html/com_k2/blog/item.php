...
<div id="k2Container" class="Blog-content itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
  ...
  <div class="itemBody yjk2_body"> 
    ...
    <div class="itemHeader yjk2_header">
      ...
      <!-- Item category -->
      <div class="itemCategory yjk2_cat"> <span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span> <a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a> </div>
      <?php endif; ?>
    ...
    <?php else: ?>
    <!-- Item text -->
    <div class="itemFullText yjk2_intro"> <?php echo $this->item->introtext; ?> </div>
    <?php endif; ?>
    <div class="clr"></div>
  ...
  <?php if($this->item->params->get('itemTags') && count($this->item->tags)): ?>
    ...
    <div class="itemTagsBlock yjk2_tags"> <span><?php echo JText::_('K2_TAGGED_UNDER'); ?></span>
      <ul class="itemTags">
        ...
        <li><a href="<?php echo $tag->link; ?>" rel="nofollow"><?php echo $tag->name; ?></a></li>
        <?php endforeach; ?>
      </ul>
      <div class="clr"></div>
    </div>
...
<div class="clr"></div>
  ...
  <div class="itemRelated">
    <h5><?php echo JText::_("K2_RELATED_ITEMS_BY_TAG"); ?></h5>
    <ul>
