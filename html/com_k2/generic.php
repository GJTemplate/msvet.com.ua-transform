  ...
  <div class="genericItemList">
    ...
    <div class="genericItemView">
      <div class="genericItemBody yjk2_body">
        ...
        <!-- Item Image -->
        <div class="genericItemImageBlock"> <span class="genericItemImage"> <a href="<?php echo $item->link; ?>" title="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>">
        ...
        <div class="genericItemHeader yjk2_header">
          ...
          <!-- Date created --> 
          <span class="genericItemDateCreated yjk2_date"> <?php echo JHTML::_('date', $item->created , JText::_('YJ_DATE_FORMAT')); ?> </span>
          <?php endif; ?>
          <?php if($this->params->get('genericItemCategory')): ?>
          <!-- Item category name -->
          <div class="genericItemCategory yjk2_cat"> <span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span> <a href="<?php echo $item->category->link; ?>"><?php echo $item->category->name; ?></a> </div>
          <?php endif; ?>
        </div>
        <?php if($this->params->get('genericItemIntroText')): ?>
        <!-- Item introtext -->
        <div class="genericItemIntroText yjk2_intro"> <?php echo $item->introtext; ?> </div>
        <?php endif; ?>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
      ...
      <!-- Item "read more..." link -->
      <div class="genericItemReadMore"> <a class="k2ReadMore button_color" href="<?php echo $item->link; ?>"> <?php echo JText::_('YJ_READMORE'); ?> </a> </div>
      <?php endif; ?>
      <div class="clr"></div>
    </div>
    <!-- End K2 Item Layout -->
