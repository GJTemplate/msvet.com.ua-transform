  ...
  <div class="tagItemList">
    ...
    <div class="tagItemView">
      <div class="tagItemBody yjk2_body">
        ...
        <!-- Item Image -->
        <div class="tagItemImageBlock"> <span class="tagItemImage"> <a href="<?php echo $item->link; ?>" title="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>">
        ...
        <div class="tagItemHeader yjk2_header">
          ...
          <!-- Item title -->
          <h2 class="tagItemTitle yjk2_title">
          ...
          <!-- Date created --> 
          <span class="tagItemDateCreated yjk2_date"> <?php echo JHTML::_('date', $item->created , JText::_('YJ_DATE_FORMAT')); ?> </span>
          <?php endif; ?>
        ...
        <!-- Item introtext -->
        <div class="tagItemIntroText yjk2_intro"> <?php echo $item->introtext; ?> </div>
        <?php endif; ?>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
      ...
      <!-- Item "read more..." link -->
      <div class="tagItemReadMore yjk2_readmore"> <a class="k2ReadMore button_color" href="<?php echo $item->link; ?>"> <?php echo JText::_('YJ_READMORE'); ?> </a> </div>
      <?php endif; ?>
      <div class="clr"></div>
    </div>
    <!-- End K2 Item Layout -->
