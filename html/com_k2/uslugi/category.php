...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemListCategoriesBlock">
    ...
    <div class="itemListCategory">
      ...
      <!-- Category title -->
      <h1><?php echo $this->category->name; ?>
    ...
    <div class="itemListSubCategories">
      ...
      <div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('subCatColumns'), 1).'%;"'; ?>>
        <div class="subCategory">
          ...
          <span class="yj_hover"> <span class="yj_hover_in"> <span class="yj_hover_title"><?php echo $subCategory->name; ?></span> </span> <img alt="<?php echo K2HelperUtilities::cleanHtml($subCategory->name); ?>" src="<?php echo $subCategory->image; ?>" /> </span>
          <?php else: ?>
          ...
          <!-- Subcategory title -->
          <h2> <a href="<?php echo $subCategory->link; ?>"> <?php echo $subCategory->name; ?>
            <?php if($this->params->get('subCatTitleItemCounter')) echo ' ('.$subCategory->numOfItems.')'; ?>
            </a> </h2>
          <?php endif; ?>
          <?php if($this->params->get('subCatDescription')): ?>
          <!-- Subcategory description -->
          <p class="yjk2_intro"><?php echo $subCategory->description; ?></p>
          <?php endif; ?>
          
          <!-- Subcategory more... --> 
          <a class="subCategoryMore button_color" href="<?php echo $subCategory->link; ?>"> <?php echo JText::_('K2_READ_MORE'); ?> </a>
          <div class="clr"></div>
        </div>
      </div>
      <?php if(($key+1)%($this->params->get('subCatColumns'))==0): ?>
      <div class="clrcat-line">&nbsp;</div>
      <div class="clr"></div>
