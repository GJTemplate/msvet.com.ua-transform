...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
  ...
  <div class="catItemBody yjk2_body"> 
    ...
    <!-- Item Image -->
    <div class="catItemImageBlock ServiceBlock effect-apollo"> <span class="catItemImage"> <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
      <?php if ($hovereffect == 1 ): ?>
      <span class="yj_hover"> <span class="yj_hover_in"> <span class="yj_hover_title"><?php echo $this->item->title; ?></span> </span> <img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" /> </span>
      <?php else: ?>
    ...
    <?php endif; ?>
    <div class="catItemHeader yjk2_header ServiceHeader">
      <?php if($this->item->params->get('catItemTitle')): ?>
      <!-- Item title -->
      <h3 class="catItemTitle ServiceTitle">
      ...
      <!-- Date created --> 
      <span class="catItemDateCreated yjk2_date"> <?php echo JHTML::_('date', $this->item->created , JText::_('YJ_DATE_FORMAT')); ?> </span>
      <?php endif; ?>
      <?php if($this->item->params->get('catItemAuthor')): ?>
      <!-- Item Author --> 
      <span class="catItemAuthor yjk2_author"> <?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?>
      ...
      <!-- Item Hits -->
      <div class="catItemHitsBlock yjk2_hits"> <span class="catItemHits"> <?php echo JText::_('K2_READ'); ?> <b><?php echo $this->item->hits; ?></b> <?php echo JText::_('K2_TIMES'); ?> </span> </div>
      <?php endif; ?>
      <?php if($this->item->params->get('catItemCategory')): ?>
      <!-- Item category name -->
      <div class="catItemCategory yjk2_cat"> <span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span> <a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a> </div>
      <?php endif; ?>
      <?php if($this->item->params->get('catItemCommentsAnchor') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) ): ?>
      <!-- Anchor link to comments below -->
      <div class="catItemCommentsLink yjk2_comments">
    ...
    <!-- Item introtext -->
    <div class="catItemIntroText yjk2_intro"> <?php echo $this->item->introtext; ?> </div>
    <?php endif; ?>
    ...
    <span class="catItemDateModified yjk2_modified"> <?php echo JText::_('K2_LAST_MODIFIED_ON'); ?> <?php echo JHTML::_('date', $this->item->modified, JText::_('K2_DATE_FORMAT_LC2')); ?> </span>
    <?php endif; ?>
    <?php endif; ?>
    <div class="clr"></div>
  ...
  <div class="catItemLinks">
    ...
    <!-- Item Rating -->
    <div class="catItemRatingBlock yjk2_rate"> <span><?php echo JText::_('K2_RATE_THIS_ITEM'); ?></span>
    ...
    <!-- Item tags -->
    <div class="catItemTagsBlock yjk2_tags"> <!--span><?php //echo JText::_('K2_TAGGED_UNDER'); ?></span-->
  ...
  <!-- Item "read more..." link -->
  <div class="catItemReadMore"><a class="k2ReadMore button_color" href="<?php echo $this->item->link; ?>"> <?php echo JText::_('K2_READ_MORE'); ?> </a> </div>
  <?php endif; ?>
  <div class="clr"></div>
