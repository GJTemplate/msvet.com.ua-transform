...
<div id="k2Container" class="Usluga-content itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
  ...
  <div class="itemBody yjk2_body"> 
    ...
    <!-- Item Image -->
    <div class="itemImageBlock"> <span class="itemImage"> <a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
      <?php if ($hovereffect == 1 ): ?>
      <span class="yj_hover"> <img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" /> </span>
      <?php else: ?>
    ...
    <div class="itemHeader yjk2_header">
      ...
      <!-- Date created --> 
      <span class="itemDateCreated yjk2_date"> <?php echo JHTML::_('date', $this->item->created , JText::_('YJ_DATE_FORMAT')); ?> </span>
      <?php endif; ?>
      <?php if($this->item->params->get('itemAuthor')): ?>
      <!-- Item Author --> 
      <span class="itemAuthor yjk2_author"> <?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?>&nbsp;
      ...
      <!-- Item Hits --> 
      <span class="itemHits yjk2_hits"> <?php echo JText::_('K2_READ'); ?> <b><?php echo $this->item->hits; ?></b> <?php echo JText::_('K2_TIMES'); ?> </span>
      <?php endif; ?>
    </div>
    <?php if(!empty($this->item->fulltext)): ?>
    <?php if($this->item->params->get('itemIntroText')): ?>
    <!-- Item introtext -->
    <div class="itemIntroText yjk2_intro"> <?php echo $this->item->introtext; ?> </div>
    <?php endif; ?>
    <?php if($this->item->params->get('itemFullText')): ?>
    <!-- Item fulltext -->
    <div class="itemFullText yjk2_intro"> <?php echo $this->item->fulltext; ?> </div>
    <?php endif; ?>
    <?php else: ?>    
       
    <!-- Item text -->
    <div class="itemFullText yjk2_intro"> <?php echo $this->item->introtext; ?>  
    
        <!-- Модуль ЗАКАЗА-->    
        <?php if (JModuleHelper::renderModule(array_shift(JModuleHelper::getModules('item_k2mod2'))) != "")  : ?>   
            <div class="clr"></div>
            <div class="item_k2mod2_wrap">
            <div><h3>Еще остались вопросы?</h3></div>
            
                <?php $pos = "item_k2mod2"; 
                    $modules =& JModuleHelper::getModules($pos); foreach ($modules as $module){
        ...
        <!-- Модуль портфолио-->    
        <?php if (JModuleHelper::renderModule(array_shift(JModuleHelper::getModules('item_k2mod1'))) != "")  : ?>   
            <div class="clr"></div>
            <div class="item_k2mod1_wrap">
            <div><h3>Последние работы по данному направлению:</h3></div>
                <?php $pos = "item_k2mod1"; 
                    $modules =& JModuleHelper::getModules($pos); foreach ($modules as $module){
                    echo JModuleHelper::renderModule($module);}
                ?>
    ...
    <div class="itemContentFooter">
      <?php if($this->item->params->get('itemDateModified') && intval($this->item->modified)!=0): ?>
      <!-- Item date modified --> 
      <span class="itemDateModified yjk2_modified"> <?php echo JText::_('K2_LAST_MODIFIED_ON'); ?> <?php echo JHTML::_('date', $this->item->modified, JText::_('K2_DATE_FORMAT_LC2')); ?> </span>
      <?php endif; ?>
      <div class="clr"></div>
    </div>
    <?php endif; ?>
  ...
  <?php endif; ?>
  <?php if($this->item->params->get('itemRating') || $this->item->params->get('itemTags') || $this->item->params->get('itemAttachments')): ?>
  <div class="itemLinks">
    <?php if($this->item->params->get('itemRating')): ?>
    <!-- Item Rating -->
    <div class="itemRatingBlock yjk2_rate"> <span><?php echo JText::_('K2_RATE_THIS_ITEM'); ?></span>
    ...
    <!-- Item attachments -->
    <div class="itemAttachmentsBlock yjk2_attachment"> <span><?php echo JText::_('K2_DOWNLOAD_ATTACHMENTS'); ?></span>
  ...
  <div class="itemVideoBlock yjk2_video">
  ...
  <div class="itemImageGallery">
    ...
    <div class="wrap_galleryItem"><?php echo $this->item->gallery; ?></div> 
   </div>
  <?php endif; ?>
  ...
  <?php if($this->item->params->get('itemTags') && count($this->item->tags)): ?>
    <!-- Item tags -->
    <div class="itemTagsBlock yjk2_tags"> <span><?php echo JText::_('K2_TAGGED_UNDER'); ?></span>
      <ul class="itemTags">
          ...
          <div class="wrap_comment_soc">
          	...
          	<div class="wrap_comment_fb">
            	<div class="comment_fb"> 
                	<div class="fb-comments" data-href="<?php echo JFactory::getConfig()->get('live_site',''); ?>/<?php $uri = &JFactory::getURI();
						$url = $uri->toString(array('path', 'query', 'fragment'));
						print $url; ?>" data-numposts="10">
                    </div>
                </div>
            </div>
