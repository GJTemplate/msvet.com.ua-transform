  ...
  <div class="userItemList">
    ...
    <div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>"> 
      ...
      <div class="userItemBody yjk2_body"> 
        ...
        <!-- Item Image -->
        <div class="userItemImageBlock"> <span class="userItemImage"> <a href="<?php echo $item->link; ?>" title="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>">
          <?php if ($hovereffect == 1 ): ?>
          <span class="yj_hover"> <span class="yj_hover_in"> <span class="yj_hover_title"><?php echo $item->title; ?></span> </span> <img src="<?php echo $item->imageGeneric; ?>" alt="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>" style="width:<?php echo $this->params->get('itemImageGeneric'); ?>px; height:auto;" /> </span>
          <?php else: ?>
        ...
        <?php endif; ?>
        <div class="userItemHeader yjk2_header">
          <?php if($this->params->get('userItemTitle')): ?>
          <!-- Item title -->
          <h3 class="userItemTitle yjk2_title">
          ...
          <!-- Date created --> 
          <span class="userItemDateCreated yjk2_date"> <?php echo JHTML::_('date', $item->created , JText::_('YJ_DATE_FORMAT')); ?> </span>
          <?php endif; ?>
          
          <!-- Item category name -->
          <?php if($this->params->get('userItemCategory')): ?>
          <div class="userItemCategory yjk2_cat"> <span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span> <a href="<?php echo $item->category->link; ?>"><?php echo $item->category->name; ?></a> </div>
          <?php endif; ?>
          <?php if($this->params->get('userItemCommentsAnchor') && ( ($this->params->get('comments') == '2' && !$this->user->guest) || ($this->params->get('comments') == '1')) ): ?>
          <!-- Anchor link to comments below -->
          <div class="userItemCommentsLink yjk2_comments">
        ...
        <!-- Item introtext -->
        <div class="userItemIntroText yjk2_intro"> <?php echo $item->introtext; ?> </div>
        <?php endif; ?>
        <div class="clr"></div>
      ...
      <div class="userItemLinks">
        ...
        <!-- Item tags -->
        <div class="userItemTagsBlock yjk2_tags"> <span><?php echo JText::_('K2_TAGGED_UNDER'); ?></span>
      ...
      <!-- Item "read more..." link -->
      <div class="userItemReadMore yjk2_readmore"> <a class="k2ReadMore button_color" href="<?php echo $item->link; ?>"> <?php echo JText::_('YJ_READMORE'); ?> </a> </div>
      <?php endif; ?>
      <div class="clr"></div>
