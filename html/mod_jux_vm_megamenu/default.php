...
if (!file_exists(JPATH_SITE.DS.'components'.DS.'com_virtuemart')){
	...
	//  $par = json_decode ($params->get('mega_config')) ;
	
	if( $params->get('show_img_category') ){
		$doc = JFactory::getDocument();
		$doc->addScript( '/modules/mod_jux_vm_megamenu/assets/js/media_fotos.js'  , 'text/javascript');
	} // end if
