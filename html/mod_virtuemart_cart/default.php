...
<div class="vmCartModule <?php echo $params->get('moduleclass_sfx'); ?>" id="vmCartModule">
	<?php if ($data->totalProduct and $show_price) { ?>
		<div class="show-cart">
        	<a id="cartpanel" class="cart-button" href="javascript:void(0);"><?php echo JText::_('COM_VIRTUEMART_CART_SHOW') ?></a>
        </div>
...
<div class="total_products">
	<?php if ($data->totalProduct>1) 
		$data->totalProductTxt2 = '<div class="total-items"><strong>'.vmText::_('TPL_VMT_SHOPPING_CART_LABEL').'</strong><br><span>'.vmText::sprintf('TPL_VMT_ITEM_S', $data->totalProduct).'</span></div>'; 
		
		else if ($data->totalProduct == 1) 
		$data->totalProductTxt2 = '<div class="total-items"><strong>'.vmText::_('TPL_VMT_SHOPPING_CART_LABEL').'</strong><br><span>'.vmText::_('TPL_VMT_ITEM').'</span></div>';
