		...
		<div class="ma-box-content">
			...
			<div class="text-block">
				...
				<h3 class="product-title">
					<!--a href="<?php //echo $pLink; ?>" title="<?php //echo $pName; ?>"><?php //echo mb_substr( $product->product_name, 0, 17); ?></a-->
					<a href="<?php echo $pLink; ?>" title="<?php echo $pName; ?>"><?php echo $product->product_name; ?></a>
				</h3>
				<?php endif; ?>
...
jQuery(document).ready(function($) {
	$('[data-countdown]').each(function() {
		...
		$this.countdown(finalDate, function(event) {
			$this.html(event.strftime('<div class="day"><span class="number">%D </span>days</div> <div class="hour"><span class="number">%H </span>Hours</div><div class="min"><span class="number"> %M</span> MINUTE</div> <div class="sec"><span class="number">%S </span>SECONDS</div>'));
		});
	});
});
</script>
