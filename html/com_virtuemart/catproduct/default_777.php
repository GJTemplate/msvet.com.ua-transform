...
<!-- New -->
<div class="cartproduct_title"><?php echo JText::_('CATPRODUCT_TABLE_TITLE') ?></div>
<div class="row-fluid">
	<!-- Product -->
	<div class="wrap_cartproduct">
        <div class="wrap_img_title">Изображение+Название</div>
        <div class="wrap_kolvo">Количество</div>
        <div class="wrap_ceny_total">Цена, скидка и пр. цифры/данные</div>
	</div>
    <!-- End Product --> 
    <div class="wrap_cartproduct_total">Итоговые данные</div>
    <div class="wrap_cartproduct_bottom">Купить</div>
...
<caption>55555555555555555555</caption> 
<thead>
<tr>
	<?php 
