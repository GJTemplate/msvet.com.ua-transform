...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
    ...
    <td>
        ...
        <div style="padding:3px 20px 5px 20px; background:#f0f0f0; border-bottom:1px solid #555555;"> 
            ...
            <p style="color: #333333; margin: 0 0 5px; padding: 0 0 0 2px; font-family:Arial, Helvetica, sans-serif;">Интернет-магазин <span style="color: #b70000; font-size: 1.2em; font-weight: bold; text-shadow: 1px 2px 1px #656565;">«Моя Мойка»</span></p>
        </div> 
        
	<div style="padding:20px;">	
		<?php
    //	echo JText::_('COM_VIRTUEMART_CART_MAIL_VENDOR_TITLE').$this->vendor->vendor_name.'<br/>';
        echo JText::sprintf('COM_VIRTUEMART_MAIL_VENDOR_CONTENT',$this->vendor->vendor_name,$this->shopperName,$this->currency->priceDisplay($this->orderDetails['details']['BT']->order_total,$this->currency),$this->orderDetails['details']['BT']->order_number);
