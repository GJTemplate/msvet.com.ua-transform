...
<table class="html-email" width="96%" cellspacing="0" cellpadding="0" border="0" style="font-size:14px;">
	<tr align="left" class="sectiontableheader">
		<th align="left" width="10%">
        	<strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SKU') ?></strong>
        </th>
        
		<th align="left" colspan="2" width="33%" >
		...
		<th align="right" width="11%" >
        	<strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_TAX') ?></strong>
        </th>
		  <?php } ?>
		<th align="right" width="11%"><strong><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SUBTOTAL_DISCOUNT_AMOUNT') ?></strong>
        </th>
...
<tr><td style="border-bottom: 1px solid #DAD8D8;" colspan="<?php echo $colspan ?>"></td></tr>
 <tr class="sectiontableentry1">
			<td style="color:#b70000;" colspan="5" align="right">
...
if ($this->orderDetails['details']['BT']->coupon_discount <> 0.00) {
	...
	?>
	<tr>
		<td style="color:#b70000;" align="right" class="pricePad" colspan="5">
...
<?php  } ?>
	...
	<?php
		foreach($this->orderDetails['calc_rules'] as $rule){
			...
			<tr >
				<td style="color:#b70000;" colspan="5"  align="right" class="pricePad">
