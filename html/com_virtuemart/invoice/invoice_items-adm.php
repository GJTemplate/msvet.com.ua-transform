...
<table class="html-email" width="96%" cellspacing="0" cellpadding="3" border="0" style="font-size:14px;"> 
	<tr align="left" class="sectiontableheader">
		<th align="left" width="15%" style="background-color:#F7F7F7;">
	...
	foreach($this->orderDetails['items'] as $item) {
		...
		<tr valign="top">
			...
			<td align="left" colspan="2" >
				<div float="right" ><a href="<?php echo $product_link; ?>"><?php echo $item->order_item_name; ?></a></div><br>                
...
<tr><td style="border-bottom: 1px solid #DAD8D8;" colspan="<?php echo $colspan ?>"></td></tr>
 <tr class="sectiontableentry1">
			<td style="color:#49892D;" colspan="5" align="right">
...
<?php  } ?>
	...
	<?php
		foreach($this->orderDetails['calc_rules'] as $rule){
			...
			<tr >
				<td style="color:#49892D;" colspan="5"  align="right" class="pricePad">
