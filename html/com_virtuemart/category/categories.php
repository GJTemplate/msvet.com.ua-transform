...
else if ($categories_per_row == 3) { $category_cellwidth = 'span4'; }
else if ($categories_per_row == 2) { $category_cellwidth = 'span6'; }
else if ($categories_per_row == 1) { $category_cellwidth = 'span12'; }
