...
<table width="<?php echo $widthTable ?>%" cellspacing="0" cellpadding="0" border="0" class="order_tab">
	<tr align="left" class="sectiontableheader">
		...
		<th align="right" width="8%" ><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_PRICE') ?></th>
		<th align="left" width="8%"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_QTY') ?></th>
		<?php if ( VmConfig::get('show_tax')) { ?>
		<!--<th align="right" width="10%" ><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_TAX') ?></th>-->
		  <?php } ?>
		<th align="right" width="12%"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_SUBTOTAL_DISCOUNT_AMOUNT') ?></th>
		<th align="right" width="12%"><?php echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_TOTAL') ?></th>
	</tr>
<?php
...
if ($this->orderdetails['details']['BT']->coupon_discount <> 0.00) {
	...
	?>
	<tr>
		<td align="right" class="pricePad" colspan="4"><?php echo vmText::_('COM_VIRTUEMART_COUPON_DISCOUNT').$coupon_code ?></td>
...
<?php  } ?>
	...
	<?php
		foreach($this->orderdetails['calc_rules'] as $rule){
			...
			<tr >
				<td colspan="3"  align="right" class="pricePad"><?php echo $rule->calc_rule_name ?> </td>
...
//  Стоимость обработки и доставки
 ...
 ?>
	<tr>
		<td align="right" class="pricePad" colspan="4">Стоимость доставки<?php //echo vmText::_('COM_VIRTUEMART_ORDER_PRINT_SHIPPING') ?></td>
