...
jQuery('.continue_link').on(function() { 
alert();
	/*jQuery.fancybox.close();*/
	///jQuery(document).trigger('close.fancybox');
	return false;
});
...
echo '<a class="continue floatleft" href="javascript:void(0)" onclick="jQuery.fancybox.close()" >' . JText::_('COM_VIRTUEMART_CONTINUE_SHOPPING'). '</a>';
//echo '<a class="continue_link" href="#" >' . vmText::_('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</a>';
