...
//				$step=$prow->min_order_level;
		   ...
		   <input type="text"
				   ...
				   title="<?php echo  vmText::_('COM_VIRTUEMART_CART_UPDATE') ?>" class="inputbox quantity-input js-recalculate" size="3" maxlength="4" name="quantity[]" value="<?php echo $prow->quantity ?>" />
